...
//  GiniVision
//
//  Created by Peter Pult on 17/08/16.
//  Copyright © 2016 Gini. All rights reserved.
//

#import "Constants.h"

NSString *const kGiniClientId = GINI_CLIENT_ID;
NSString *const kGiniClientSecret = GINI_CLIENT_SECRET;

NSString *const kSettingsExampleAppVersionKey = @"SETTINGS_VERSIONS_EXAMPLE_APP";
