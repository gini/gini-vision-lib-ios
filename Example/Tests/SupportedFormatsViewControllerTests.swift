...
final class SupportedFormatsViewControllerTests: XCTestCase {
    ...
    var sections: [SupportedFormatCollectionSection] = [
        (NSLocalizedString("ginivision.help.supportedFormats.section.1.title",
                           bundle: Bundle(for: GiniVision.self),
                           comment: "title for supported formats section"),
         [NSLocalizedString("ginivision.help.supportedFormats.section.1.item.1",
                            bundle: Bundle(for: GiniVision.self),
                            comment: "message for first item on supported formats section"),
          NSLocalizedString("ginivision.help.supportedFormats.section.1.item.2",
                            bundle: Bundle(for: GiniVision.self),
                            comment: "message for second item on supported formats section"),
          NSLocalizedString("ginivision.help.supportedFormats.section.1.item.3",
                            bundle: Bundle(for: GiniVision.self),
        ...
        (NSLocalizedString("ginivision.help.supportedFormats.section.2.title",
                           bundle: Bundle(for: GiniVision.self),
                           comment: "title for unsupported formats section"),
         [NSLocalizedString("ginivision.help.supportedFormats.section.2.item.1",
                            bundle: Bundle(for: GiniVision.self),
                            comment: "message for first item on unsupported formats section"),
          NSLocalizedString("ginivision.help.supportedFormats.section.2.item.2",
                            bundle: Bundle(for: GiniVision.self),
