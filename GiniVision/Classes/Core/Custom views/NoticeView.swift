...
final class NoticeView: UIView {
    ...
    lazy var textLabel: UILabel = {
        ...
        label.font = self.giniConfiguration.customFont.isEnabled ?
            self.giniConfiguration.customFont.with(.regular, size: 14, style: .body) :
    ...
    lazy var actionButton: UIButton = {
        ...
        button.titleLabel?.font =  self.giniConfiguration.customFont.with(.regular, size: 16, style: .caption1)
