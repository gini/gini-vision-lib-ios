...
final class CaptureSuggestionsView: UIView {
    ...
    fileprivate func addConstraints() {
        ...
        // suggestionText
        ConstraintUtils.addActiveConstraint(item: suggestionText, attribute: .top, relatedBy: .equal, toItem: suggestionContainer, attribute: .top, multiplier: 1, constant: 16)
        ConstraintUtils.addActiveConstraint(item: suggestionText, attribute: .trailing, relatedBy: .equal, toItem: suggestionContainer, attribute: .trailing, multiplier: 1, constant: -16, priority: 999)
        ConstraintUtils.addActiveConstraint(item: suggestionText, attribute: .bottom, relatedBy: .equal, toItem: suggestionContainer, attribute: .bottom, multiplier: 1, constant: -40)
